...
PanelWindow {
    ...
    implicitWidth: 364
    implicitHeight: popupColumn.implicitHeight + 64 + 12
    ...
    Rectangle {
        ...
        Rectangle {
            ...
            radius: 2
            color: {
                if (delegateItem.urgency === 2) return Colors.red;
                if (delegateItem.urgency === 0) return Colors.overlay;
        ...
        MouseArea {
            ...
            onExited: {
                if (!dismissAnim.running) dismissTimer.start()
            }
            onClicked: dismissAnim.start()
        }
    }
